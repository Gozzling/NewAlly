    ...
    extend: {
      ...
      colors: {
        ally: {
          ...
          surface0: 'var(--color-ally-surface0)',
          surface1: 'var(--color-ally-surface1)',
          surface2: 'var(--color-ally-surface2)',
          placementFirst: 'var(--color-placement-first)',
          placementTop4: 'var(--color-placement-top4)',
          placementBot4: 'var(--color-placement-bot4)',
          success: '#10b981',
          warning: '#f59e0b',
          error:   '#ef4444',

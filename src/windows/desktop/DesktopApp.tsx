...
export function DesktopApp() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-ally-bg text-ally-text font-sans">
      ...
      {/* Page area */}
      <div className="flex-1 overflow-y-auto bg-ally-bg py-6">
        {activePage === 'In Game' ? (
            <div className="max-w-5xl mx-auto px-6"><div className="text-[11px] uppercase tracking-widest text-ally-muted mb-4">Live Lobby</div><div className="grid grid-cols-4 gap-4">

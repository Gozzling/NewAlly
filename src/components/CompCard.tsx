...
/**
 * CompCard component displays detailed information about a team composition.
 * Wrapped in React.memo to skip expensive re-renders of the composition list when parent state
 * (like filters or search) updates, provided the comp data and callbacks are stable.
 */
export const CompCard = React.memo(function CompCard({ comp, isPinned, onPinToggle, onImport, onOverlayToggle }: CompCardProps) {
